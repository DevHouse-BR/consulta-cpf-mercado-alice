...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    ...
    $this->Messages["CCS_CannotSeek"] = "No  possivel encontrar o registro especificado.";
    $this->Messages["CCS_Charset"] = "windows-1252";
    $this->Messages["CCS_Clear"] = "Limpar";
    $this->Messages["CCS_CustomLinkField"] = "Ver";
    $this->Messages["CCS_CustomOperationError_MissingParameters"] = "Um ou mais parmetros esto faltando para Atualizar/Apagar. A aplicao est mal configurada.";
    $this->Messages["CCS_DatabaseCommandError"] = "Erro de comando do banco de dados.";
    $this->Messages["CCS_DatePickerNav61"] = "O calendrio no  compatvel com o Netscape 6.1";
    $this->Messages["CCS_Delete"] = "Apagar";
    $this->Messages["CCS_DeleteConfirmation"] = "Apagar registros?";
    $this->Messages["CCS_DESC"] = "Descendente";
    $this->Messages["CCS_DirectoryFormPrefix"] = "Diretrio";
    $this->Messages["CCS_DirectoryFormSuffix"] = "";
    $this->Messages["CCS_FileNotFound"] = "O arquivo {0} especificado em {1} no foi encontrado.";
    $this->Messages["CCS_FilesFolderNotFound"] = "No foi possivel enviar o arquivo especificado em {0} - Pasta para upload no existe.";
    $this->Messages["CCS_Filter"] = "Palavra-chave";
    $this->Messages["CCS_First"] = "Primeiro";
    $this->Messages["CCS_GridFormPrefix"] = "Lista de";
    $this->Messages["CCS_GridFormSuffix"] = "";
    $this->Messages["CCS_GridPageNumberError"] = "Nmero de pgina invlido.";
    $this->Messages["CCS_GridPageSizeError"] = "(CCS06) Tamanho de pgina invlido.";
    $this->Messages["CCS_IncorrectEmailFormat"] = "Formato de email invlido no campo {0}.";
    $this->Messages["CCS_IncorrectFormat"] = "O valor no campo {0} no  valido. Use o seguinte formato: {1}.";
    $this->Messages["CCS_IncorrectPhoneFormat"] = "Formato de nmero de telefone invlido no campo {0}.";
    $this->Messages["CCS_IncorrectValue"] = "O valor no campo {0} no  valido.";
    $this->Messages["CCS_IncorrectZipFormat"] = "Formato de CEP invlido no campo {0}.";
    $this->Messages["CCS_Insert"] = "Adicionar";
    $this->Messages["CCS_InsertLink"] = "Novo";
    $this->Messages["CCS_InsufficientPermissions"] = "Permisses insuficientes no sistema de arquivos para enviar o arquivo especificado em {0}.";
    $this->Messages["CCS_LanguageID"] = "en";
    $this->Messages["CCS_LargeFile"] = "O Tamanho do arquivo no campo {0}  muito grande.";
    $this->Messages["CCS_Last"] = "ltimo";
    $this->Messages["CCS_LocaleID"] = "en";
    $this->Messages["CCS_Login"] = "Login";
    $this->Messages["CCS_LoginBtn"] = "Login";
    $this->Messages["CCS_LoginError"] = "Login ou Senha incorretos.";
    $this->Messages["CCS_LogoutBtn"] = "Logout";
    $this->Messages["CCS_Main"] = "Principal";
    $this->Messages["CCS_MaskValidation"] = "A validao de mscara falhou para o campo {0}.";
    $this->Messages["CCS_MaximumLength"] = "O nmero de smbolos no campo {0} no pode ser maior que {1}.";
    $this->Messages["CCS_MaximumValue"] = "O valor no campo {0} no pode ser maior que {1}.";
    $this->Messages["CCS_MinimumLength"] = "O nmero de smbolos no campo {0} no pode ser menor que {1}.";
    $this->Messages["CCS_MinimumValue"] = "O valor no campo {0} no pode ser menor que {1}.";
    $this->Messages["CCS_More"] = "Mais...";
    $this->Messages["CCS_Next"] = "Prximo";
    $this->Messages["CCS_NoCategories"] = "Nenhuma categoria encontrada";
    $this->Messages["CCS_NoRecords"] = "Nenhum registro";
    $this->Messages["CCS_Of"] = "de";
    $this->Messages["CCS_OperationError"] = "No foi possivel executar a operao: {0}. Um ou mais parmetros no foram especificados.";
    $this->Messages["CCS_Password"] = "Senha";
    $this->Messages["CCS_Previous"] = "Anterior";
    $this->Messages["CCS_RecordFormPrefix"] = "Novo/Editar";
    $this->Messages["CCS_RecordFormPrefix2"] = "Ver";
    $this->Messages["CCS_RecordFormSuffix"] = "";
    $this->Messages["CCS_RecPerPage"] = "Registros por pgina";
    $this->Messages["CCS_RememberLogin"] = "Lembrar meu login e senha";
    $this->Messages["CCS_ReportFormPrefix"] = "";
    $this->Messages["CCS_ReportFormSuffix"] = "";
    $this->Messages["CCS_ReportPageNumber1"] = "Pgina";
    $this->Messages["CCS_ReportPageNumber2"] = "de";
    $this->Messages["CCS_ReportPrintLink"] = "Verso para impresso";
    $this->Messages["CCS_ReportTotal"] = "Total";
    $this->Messages["CCS_RequiredField"] = "O valor no campo {0}  requerido.";
    $this->Messages["CCS_RequiredFieldUpload"] = "O anexo de arquivo para o campo {0}  requerido.";
    $this->Messages["CCS_RequiredSMTPserver_or_Dir"] = "Favor especificar o servidor SMTP ou selecionar um diretrio para o componente de email CDO.Message.";
    $this->Messages["CCS_Search"] = "Busca";
    $this->Messages["CCS_SearchFormPrefix"] = "Busca";
    $this->Messages["CCS_SearchFormSuffix"] = "";
    $this->Messages["CCS_SelectField"] = "Selecionar Campo";
    $this->Messages["CCS_SelectOrder"] = "Selecionar Ordem";
    $this->Messages["CCS_SelectValue"] = "Selecionar Valor";
    $this->Messages["CCS_SortBy"] = "Ordenar";
    $this->Messages["CCS_SortDir"] = "Direo da Ordenao";
    $this->Messages["CCS_SubmitConfirmation"] = "Enviar registros?";
    $this->Messages["CCS_TempFolderNotFound"] = "No foi possivel enviar o arquivo especificado em {0} - pasta temporria de upload no existe.";
    $this->Messages["CCS_TempInsufficientPermissions"] = "Permisses insuficientes na parta temporria para enviar o arquivo especificado em {0}.";
    $this->Messages["CCS_Today"] = "Hoje";
    $this->Messages["CCS_TotalRecords"] = "Total de Registros:";
    $this->Messages["CCS_UniqueValue"] = "O valor no campo {0} is already in database.";
    $this->Messages["CCS_Update"] = "Enviar";
    $this->Messages["CCS_UploadComponentError"] = "Um erro ocorreu ao iniciar o componente de upload.";
    $this->Messages["CCS_UploadComponentNotFound"] = "{0} componente de upload {1} no foi encontrado. Por favor, instale o componente ou selecione outro.";
    $this->Messages["CCS_UploadingError"] = "Um erro ocorreu ao enviar o arquivo especificado em {0}. Descrio do erro: {1}.";
    $this->Messages["CCS_UploadingTempFolderError"] = "Um erro ocorreu ao enviar o arquivo especificado em {0} para uma pasta temporria. Descrio do erro: {1}.";
    $this->Messages["CCS_WrongType"] = "O tipo de arquivo especificado no campo {0} no  permitido.";
    $this->IsLoaded = true;
  }
